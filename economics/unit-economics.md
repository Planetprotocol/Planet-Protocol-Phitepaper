...
A batch may return less than its disclosed terms, return only partial principal, or result in total loss of capital. See [Risks](../project/risks.md) for full risk disclosures.
