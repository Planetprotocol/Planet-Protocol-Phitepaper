...
Once the window closes, an operator can sweep any unclaimed balance to a receiver address configured by the factory. **Holders who do not claim within 180 days forfeit their share to that address.** See [Claim Window Risk](../Risks.md#claim-and-refund-window-risk).
