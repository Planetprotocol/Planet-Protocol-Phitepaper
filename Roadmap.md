...
Planet Protocol's development follows a phased approach: prove the model first, then scale systematically. Each phase builds on verified outcomes from the previous one.
...
- Planet Points Program designed — Complete
...
- Planet Points Program live and accumulating participant activity
...
- $PNT governance token generation event
- Originator staking mechanism activated
- Points-to-$PNT airdrop conversion
...
- Decentralized verification network (reducing reliance on Planet Labs for milestone confirmation)
...
**Incremental decentralization:** Planet Labs operates the protocol centrally today to ensure quality and safety. Decentralization is a goal, not a starting point.
